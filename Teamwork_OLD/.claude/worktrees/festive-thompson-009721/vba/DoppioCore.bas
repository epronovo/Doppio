...
' VERSION
' =============================================================================
Public Const DOPPIO_VERSION As String = "v2.01"
...
' =============================================================================
Public Const COLOR_MANDATORY As Long = 8519680     ' RGB(130, 0, 0) - Dark red
...
''
Public Function ApiTypeToString(apiType As apiType) As String
    Select Case apiType
        Case ApiType_MI: ApiTypeToString = "API"
        Case ApiType_IDM: ApiTypeToString = "IDM"
        Case ApiType_IPS: ApiTypeToString = "IPS"
        Case ApiType_FileMng: ApiTypeToString = "FileMng"
        Case ApiType_XtendM3: ApiTypeToString = "XtendM3"
        Case ApiType_FNC: ApiTypeToString = "FNC"
        Case ApiType_ExportMI: ApiTypeToString = "EXPORTMI"
        Case Else: ApiTypeToString = "API"
    End Select
End Function
...
Public Function Core_ReadFileToString(filePath As String) As String
    ...
    #If Mac Then
        ' Mac: Use AppleScript to read UTF-8 file
        Dim script As String
        Dim result As String
        
        ' Use AppleScript to read file as UTF-8
        script = "read (POSIX file """ & filePath & """) as âclass utf8Ž"
