...
# ionapi/ is a shared repo-root folder of .ionapi tenant-credential files, used
# by every Infor automation tool in this repo (M3 Security, ADP<->Concur, MIG
# sync) - not package-local, so don't point this at BASE_DIR/"ionapi".
