Attribute VB_Name = "Doppio_Cache"
''
' Doppio Cache Module
...
Public Function Cache_TryGetFromCache(cacheKey As String, ByRef response As apiResponse) As Boolean
    ...
    If Left(response.data, 1) = "{" Then
        On Error Resume Next
        Set json = ParseJson(response.data)
...
Public Sub Cache_StoreInCache(cacheKey As String, response As apiResponse, _
    ...
    #If DEBUG_MODE Then
        Debug.Print "Cache_StoreInCache: Cache STORE: " & cacheKey
    #End If
End Sub
...
Public Sub Cache_ClearCache()
    ...
    #If DEBUG_MODE Then
        Debug.Print "Cache_ClearCache: Cache CLEARED"
    #End If
End Sub
...
''
Public Function ZZZ_Cache_CacheCount() As Long
    EnsureInitialized
    ZZZ_Cache_CacheCount = m_Cache.count
End Function
...
Public Sub Cache_LoadCacheFromSheet()
    ...
    #If DEBUG_MODE Then
        Debug.Print "Cache_LoadCacheFromSheet: Loaded " & m_Cache.count & " entries from cache sheet"
    #End If
End Sub
...
Public Sub Cache_RecordCache_Dump()
    ...
    If ActiveSheet.name = "Cache" Then
        ...
        buttonActions = Array("Cache_RecordCache_Dump", "Cache_RecordCache_Load", "Cache_RecordCache_Reset", "Cache_RecordCache_Close")
